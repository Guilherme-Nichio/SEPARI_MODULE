...
import { BtnPlataforma } from '../site/EmBreve'
        ...
        <div className="navbar-topstrip-inner">
          ...
          <div className="navbar-topstrip-actions">
            ...
            <Link to="/maquinas" className="navbar-topstrip-cta navbar-topstrip-cta--alt">
              Máquinas Separi <ArrowRight size={13} />
            </Link>
          </div>
        </div>
      </div>
      ...
      <nav className={`navbar ${scrolled ? 'scrolled' : ''}`}>
              ...
              <div className="mega-inner">
                ...
                <div className="mega-grid mega-grid--products">
                  <Link to="/produtos/separadoras" className="mega-item mega-item--media">
                    <span className="mega-thumb"><img src="/menu/separadoras.jpg" alt="" loading="lazy" onError={(e) => { e.currentTarget.style.display = 'none' }} /></span>
                  ...
                  <Link to="/produtos/centrifugas" className="mega-item mega-item--media">
                    <span className="mega-thumb"><img src="/menu/centrifugas.jpg" alt="" loading="lazy" onError={(e) => { e.currentTarget.style.display = 'none' }} /></span>
                    <span className="mega-text">
                  ...
                  <Link to="/produtos#aplicacoes" className="mega-item mega-item--media">
                    <span className="mega-thumb"><img src="/menu/setores.jpg" alt="" loading="lazy" onError={(e) => { e.currentTarget.style.display = 'none' }} /></span>
                    <span className="mega-text">
                  ...
                  <Link to="/produtos#automacao" className="mega-item mega-item--media">
                    <span className="mega-thumb"><img src="/menu/automacao.jpg" alt="" loading="lazy" onError={(e) => { e.currentTarget.style.display = 'none' }} /></span>
                    <span className="mega-text">
                  ...
                  <Link to="/maquinas" className="mega-item mega-item--media">
                    <span className="mega-thumb"><img src="/menu/maquinas.jpg" alt="" loading="lazy" onError={(e) => { e.currentTarget.style.display = 'none' }} /></span>
                    <span className="mega-text">
                      <span className="mega-title">Máquinas Separi</span>
                      <span className="mega-desc">Linha própria de separadoras novas, com qualidade de fábrica.</span>
                    </span>
                  </Link>
                  <Link to="/produtos#bowls" className="mega-item mega-item--media">
                    <span className="mega-thumb"><img src="/menu/bowls.jpg" alt="" loading="lazy" onError={(e) => { e.currentTarget.style.display = 'none' }} /></span>
                    <span className="mega-text">
        ...
        <div className="nav-actions">
          ...
          {isAuthenticated ? (
              ...
              <div className={`user-menu ${userMenuOpen ? 'open' : ''}`} role="menu">
                ...
                {isAdmin ? (
                  ...
                  <>
                    ...
                    <Link to="/catalogo" className="user-menu-item"><Package size={16} /> Catálogo de Peças</Link>
            ...
            <>
              {/* Mesmos botões de sempre; enquanto a plataforma está em
                  construção eles abrem o aviso em vez de navegar. */}
              <BtnPlataforma to="/login" className="btn btn-ghost btn-sm desktop-only">Entrar</BtnPlataforma>
              <BtnPlataforma to="/registro" className="btn btn-primary btn-sm">Cadastrar</BtnPlataforma>
            </>
          )}
