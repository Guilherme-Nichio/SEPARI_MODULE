...
/* ── v80: a barra do site nas páginas pós-login do cliente (no lugar da navbar
      antiga, com a faixa verde e os links para páginas que não existem mais) e
      a primeira seção da página Sobre com vídeo de fundo, como a Home. Assume
      o posto de ÚLTIMO CSS da fila pelo mesmo motivo do v79. ─────────────── */
import './styles/site/v80-nav-cliente-e-sobre.css'

/* ── v81: o aviso "estamos trabalhando nessa plataforma" (com a centrífuga
      girando), o modo "estoque em preparação" e o fechamento da
      responsividade — inclusive o hero do Sobre, que virou vídeo no v80 e
      ficou de fora do 100svh do v77. Assume o posto de ÚLTIMO CSS da fila,
      pelo mesmo motivo do v79 e do v80: estando por último, qualquer ajuste
      vence sem precisar de !important. ─────────────────────────────────── */
import './styles/v81-embreve-e-responsivo.css'
