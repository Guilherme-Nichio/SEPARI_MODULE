...
const journey = [
  { n: '01', title: 'Chegada do equipamento', desc: 'Recebimento, identificação e registro fotográfico da máquina como ela chegou à oficina.', img: '/servicos/jornada-chegada.jpg' },
  { n: '02', title: 'Desmontagem e inspeção', desc: 'Desmontagem completa com inspeção dimensional, líquido penetrante e mapa de desgaste documentado peça a peça.', img: '/servicos/jornada-desmontagem.jpg' },
  { n: '03', title: 'Orçamento técnico', desc: 'Diagnóstico transparente com escopo, peças a substituir, prazo e custo — você decide o que aprovar.', img: '/servicos/jornada-orcamento.jpg' },
  { n: '04', title: 'Aprovação e execução', desc: 'Após o aceite, executamos o serviço: balanceamento, microusinagem, troca de itens de desgaste e remontagem.', img: '/servicos/jornada-execucao.jpg' },
  { n: '05', title: 'Teste e entrega', desc: 'Run-in contínuo de 8 a 10 horas, relatório fotográfico, certificado de balanceamento e devolução pronta para operar.', img: '/servicos/jornada-entrega.jpg' }
]
...
const problems = [
  { title: 'Paradas não planeadas', desc: 'Perda de horas de produção valiosas por falhas que poderiam ser previstas e corrigidas antes de quebrarem.', prevent: 'Inspeção programada e leitura de vibração antecipam a falha antes da quebra.' },
  { title: 'Contaminação e danos', desc: 'Contaminação do produto final ou danos irreversíveis aos componentes internos (rotores e eixos) do separador.', prevent: 'Troca de vedações e gaxetas no intervalo certo protege o produto e os internos.' },
  { title: 'Vibração em alta rotação', desc: 'Um bowl desbalanceado vira a peça mais perigosa do chão de fábrica e destrói mancais e eixo em pouco tempo.', prevent: 'Balanceamento dinâmico mantém o conjunto na tolerância e seguro a plena rotação.' },
  { title: 'Custos exorbitantes', desc: 'O custo de uma reparação corretiva massiva é imensamente maior do que o da manutenção preventiva planejada.', prevent: 'Preventiva custa uma fração de uma corretiva — e mantém a planta produzindo.' }
]
...
export default function Servicos() {
  return (
    <div className="sv-page">
      ...
      {/* ───────── HERO — faixa 100% em teal profundo, 60% conteúdo / 40% imagem ───────── */}
      <section className="svx-hero">
        <div className="svx-bg" aria-hidden="true" />
        <div className="container svx-inner">

          {/* Conteúdo (esquerda) */}
          <div className="svx-copy">
            <nav className="sb-crumbs" aria-label="breadcrumb">
              <Link to="/">Início</Link><span>/</span><span>Serviços</span>
            </nav>
            <Reveal variant="fade-up">
              <h1 className="svx-title">
                Sua centrífuga de volta à <em>rotação de projeto.</em>
              </h1>
            </Reveal>
            {/* Linha de leitura de balanceamento — desenha uma vez no carregamento */}
            <svg className="svx-wave" viewBox="0 0 320 26" aria-hidden="true">
              <path d="M0 13 H60 L74 4 L92 22 L108 8 L122 18 L134 13 H200 L212 9 L224 17 L236 13 H320" />
            </svg>
            <Reveal variant="fade-up" delay={80}>
              <p className="svx-lead">
                Preventiva em campo, revisão geral e recondicionamento integral —
                por engenheiros formados na escola dos próprios fabricantes.
              </p>
            </Reveal>
            <Reveal variant="fade-up" delay={140}>
              <div className="svx-ctas">
          ...
          <Reveal variant="fade-up" delay={120}>
            <div className="svx-media">
              <ImageSlot src="/servicos/hero.jpg" alt="Técnico Separi executando serviço em centrífuga na oficina" />
            </div>
          </Reveal>
          ...
          <div className="sv-feature">
            <Reveal variant="fade-right">
              <div className="sv-feature-media">
                <img
                  src="/servicos/preventiva.jpg" alt="" loading="lazy" className="slot-photo"
        ...
        <div className="container">
          <div className="sv-feature sv-feature-rev">
            ...
            <Reveal variant="fade-left" delay={120}>
              <div className="sv-feature-media">
                <img
                  src="/servicos/revisao.jpg" alt="" loading="lazy" className="slot-photo"
                  onLoad={(e) => e.target.parentElement.classList.add('has-img')}
                  onError={(e) => { e.target.style.display = 'none' }}
                />
            ...
            <div className="sv-cf">
              <div className="sv-cf-panel sv-cf-panel-dark">
                <div className="sv-cf-head">
                  <div><h3>Serviço em campo</h3></div>
                </div>
