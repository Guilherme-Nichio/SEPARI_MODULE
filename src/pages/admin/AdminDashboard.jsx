...
const sectionInfo = {
  ...
  '/admin/estoque': { title: 'Estoque de Máquinas', sub: 'Cadastre as máquinas que aparecem no catálogo público em /estoque' },
...
export default function AdminDashboard() {
  ...
  const navGroups = [
    ...
    },
    {
      label: 'Catálogo',
      items: [
        { to: '/admin/estoque', label: 'Estoque de Máquinas', icon: <Package size={18} /> },
