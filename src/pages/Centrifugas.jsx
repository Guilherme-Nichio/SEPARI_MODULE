...
const benefits = [
  { title: 'Alta capacidade de sólidos', desc: 'Lida com cargas que entupiriam uma separadora de discos, ideal para lamas e polpas densas.' },
  { title: 'Operação contínua', desc: 'Alimentação, separação e descarga acontecem sem interrupção, perfeito para alto volume.' },
  { title: 'Robustez em ambiente severo', desc: 'Projetado para abrasão e três fases, resistindo a condições que outras tecnologias não suportam.' },
  { title: 'Manutenção mais simples', desc: 'Projeto mecânico direto, com pontos de desgaste bem mapeados (rosca, mancais e tambor).' }
]
        ...
        <div className="container">
          ...
          <div className="equip-hero-grid">
            ...
            <Reveal variant="fade-left" delay={220}>
              <div className="prod-hero-photo is-placeholder" style={{ '--ph': 'url("/produtos/centrifugas-hero.jpg")' }}>
