...
const process = [
  { n: '01', title: 'Você cadastra sua máquina',  desc: 'Modelo, número de série e foto da placa de identificação. Cadastro gratuito, sem compromisso.' },
  { n: '02', title: 'Nossa engenharia valida',    desc: 'Confirmamos compatibilidade técnica e liberamos um catálogo exclusivo para a sua máquina.' },
  { n: '03', title: 'Você cota peças e kits',     desc: 'Monte sua cotação peça por peça ou escolha kits prontos pré-aprovados para o seu modelo.' },
  { n: '04', title: 'Recebe orçamento técnico',   desc: 'Resposta com preço, prazo de entrega e plano de manutenção sugerido em poucos dias úteis.' }
]
...
function InfoBlockVisual({ src, alt, path = '/public/imagem.jpg' }) {
  const file = src || path.replace('/public', '')
  return (
    <div className="info-block-visual is-empty">
      <img
        src={file} alt={alt} loading="lazy"
            ...
            <div className="home-novas">
              <div className="home-novas-text">
                ...
                <p className="text-lg mt-20">
                  Linha própria de separadoras novas, com qualidade de fábrica
                  e engenharia no Brasil.
                </p>
                <Link to="/maquinas" className="btn btn-primary" style={{ marginTop: 22 }}>
              ...
              <Reveal key={i} variant="fade-up" delay={i * 90}>
                <div className="highlight-card">
                  ...
                  <div className="highlight-card-media">
                    <img
                      src={f.img.replace('/public', '')} alt="" loading="lazy"
            ...
            {process.map((p, i) => (
              <Reveal key={i} variant="fade-up" delay={i * 100}>
                <div className="process-step">
                  <div className="process-step-symbol">{p.n}</div>
                  <h4>{p.title}</h4>
                  <p>{p.desc}</p>
                </div>
              </Reveal>
