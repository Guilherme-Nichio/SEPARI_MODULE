...
const benefits = [
  { title: 'Alta eficiência de separação', desc: 'A altíssima força G separa fases de densidade muito próxima e remove finos com precisão.' },
  { title: 'Projeto sanitário', desc: 'Versões higiênicas com limpeza CIP/SIP para alimentos, bebidas e farmacêutica.' },
  { title: 'Operação contínua', desc: 'Bowls autolimpantes descarregam sólidos sem interromper o processo.' },
  { title: 'Manutenção previsível', desc: 'Serviço de bowl programado (troca de selos) conforme a aplicação e as horas de operação.' }
]
        ...
        <div className="container">
          ...
          <div className="equip-hero-grid">
            ...
            <Reveal variant="fade-left" delay={220}>
              <div className="prod-hero-photo is-placeholder" style={{ '--ph': 'url("/produtos/separadoras-hero.jpg")' }}>
