...
const values = [
  { title: 'Atendimento', sub: 'O cliente sempre em primeiro lugar.' },
  { title: 'Respeito', sub: 'Relações transparentes e éticas.' },
  { title: 'Melhoria', sub: 'Sempre à procura de fazer melhor.' },
  { title: 'Integridade', sub: 'Agimos com honestidade em tudo.' },
  { title: 'Confiança', sub: 'Construída com resultados.' }
]

// Equipe — troque a foto pelo arquivo indicado em `img`
const team = [
  { role: 'Direção', name: 'Hugo Rafacho', img: '/public/equipe/direcao.jpg' },
  { role: 'Engenharia', name: 'Técnicos Certificados', img: '/public/equipe/engenharia.jpg' },
  { role: 'Atendimento', name: 'Suporte Técnico Especializado', img: '/public/equipe/atendimento.jpg' }
]

const edges = [
  { tag: 'Causa-raiz, não sintoma', title: 'Diagnóstico que vai fundo', desc: 'Cada equipamento que entra na nossa oficina passa por um protocolo de inspeção criteriosa. Não trocamos peça por trocar: identificamos a causa-raiz da vibração, da queda de rendimento, do desbalanceamento, do desgaste prematuro.' },
  { tag: '8 etapas documentadas', title: 'Recondicionamento completo', desc: 'Limpeza química, líquido penetrante, microusinagem, jateamento, balanceamento computadorizado em dois planos, motor retificado, pintura industrial e run-in contínuo. Cada etapa documentada num relatório técnico.' },
  { tag: 'Garantia de 3 meses', title: 'Garantia técnica', desc: 'Cada peça vendida e cada serviço executado sai com garantia documentada. Não trabalhamos com volume, trabalhamos com confiança construída cliente por cliente. É por isso que nossos clientes voltam.' }
]
...
export default function Sobre() {
  return (
    <div className="sobre-page">
      ...
      {/* ───────── HERO — statement central, claro e tipográfico ───────── */}
      <section className="abx-hero">
        <div className="abx-hero-glow" aria-hidden="true" />
        <div className="container">
          <nav className="sb-crumbs abx-crumbs" aria-label="breadcrumb">
          ...
          <div className="abx-head">
            <Reveal variant="fade-up">
              <h1 className="abx-title">
                Separamos o essencial.<br />
                <em>Entregamos confiança.</em>
              </h1>
            </Reveal>
            <Reveal variant="fade-up" delay={100}>
              <p className="abx-lead">
                Engenharia leal ao seu processo, não ao fabricante — desde 2018,
                em centrífugas industriais e marítimas.
              </p>
            </Reveal>
          </div>

          <Reveal variant="fade-up" delay={260}>
            <div className="abx-media">
              <ImageSlot src="/sobre/hero.jpg" alt="Equipe Separi na oficina em Indaiatuba" />
            </div>
          </Reveal>
        </div>
      </section>
              ...
              <Reveal key={i} variant="fade-up" delay={i * 90}>
                <div className="sb-team-card">
                  <div className="sb-team-media">
                    <img
                      src={m.img.replace('/public', '')} alt={m.name} loading="lazy"
            ...
            <Reveal variant="fade-right">
              <div className="sb-local-text">
                ...
                <ul className="sb-contact">
                  <li>R. Augusto Poltronieri, 179 - LT - Park Comercial de Indaiatuba, Indaiatuba - SP, 13347-443</li>
                  <li><a href={`https://wa.me/${WHATSAPP}`} target="_blank" rel="noopener noreferrer">+55 (19) 97405-9048</a></li>
