  ...
  return (
    <SiteLayout page="produtos" containerRef={ref}>
        ...
        <header className="hero">
          {/* Fundo em três camadas, na mesma ordem das outras páginas:

              1. a foto `prodHero` e o gradiente `.video_fallback`, que já
                 estavam aqui e continuam como rede de segurança — se o vídeo
                 faltar, falhar ou o visitante pedir movimento reduzido, é
                 isto que aparece, sem buraco na tela;
              2. o vídeo, por cima da foto;
              3. o véu verde, e por último o texto.

              Para trocar o arquivo do vídeo, mexa só em VIDEO.produtosHero,
              no site/assets.ts. Para voltar a ter apenas a foto, ponha o mp4
              em null lá: esta página não precisa de nenhuma alteração. */}
          <Bg slot="prodHero" className="bg" />
          <div className="video_fallback"></div>

          <HeroBgVideo slot="produtosHero" zIndex={1} />
