...
import { Bg, Tag, HeroVideo } from '../Media'
...
{/* 1. HERO */}
        <header className="hero" style={{ position: 'relative', overflow: 'hidden' }}>
          ...
          {/* Fundo do YouTube (Nível 1) */}
          <div style={{ position: 'absolute', zIndex: 1, top: '50%', left: '50%', transform: 'translate(-50%, -50%) scale(1.4)', width: '100vw', height: '56.25vw', minHeight: '100vh', minWidth: '177.77vh', pointerEvents: 'none' }}>
            <video autoPlay loop muted playsInline style={{ width: '100%', height: '100%', objectFit: 'cover' }}>
  {/* O caminho do src acessa a pasta public a partir da raiz */}
  <source src="/media/home/video.mp4" type="video/mp4" />
  Seu navegador não suporta a tag de vídeo.
</video>
          </div>

          {/* Gradiente escuro por cima do vídeo (Nível 2) */}
          <div
