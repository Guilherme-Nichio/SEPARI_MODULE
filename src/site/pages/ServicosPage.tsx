...
import { Bg, HeroVideo } from '../Media'
...
{/* HERO (pronto para vídeo) */}
        <header className="hero">
          ...
          {/* Fundo do YouTube com truque de Escala (Scale) para esconder controles */}
          <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', zIndex: 1, overflow: 'hidden', pointerEvents: 'none' }}>
            <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: '100vw', height: '56.25vw', minHeight: '100%', minWidth: '177.77vh' }}>
              <iframe
                style={{ 
                  width: '100%', 
                  height: '100%', 
                  pointerEvents: 'none',
                  transform: 'scale(1.3)' /* <-- Esse é o truque! Aumenta o vídeo em 30% para esconder as bordas */
                }}
                src="https://www.youtube.com/embed/XF9fQ11NIPw?autoplay=1&mute=1&controls=0&loop=1&playlist=XF9fQ11NIPw&rel=0&playsinline=1&modestbranding=1&disablekb=1&iv_load_policy=3"
                title="Vídeo de Fundo Serviços"
                frameBorder="0"
        ...
        <section className="faq">
          <div className="wrap">
            ...
            <div className="faq_list sep_reveal">
              ...
              <div className="faq_item"><button className="faq_q">Qual a garantia dos serviços executados?<span className="ic">+</span></button><div className="faq_a"><p>Os serviços de revisão e recondicionamento contam com garantia de doze meses, acompanhados de relatório técnico e certificado.</p></div></div>
            </div>
          </div>
        </section>
